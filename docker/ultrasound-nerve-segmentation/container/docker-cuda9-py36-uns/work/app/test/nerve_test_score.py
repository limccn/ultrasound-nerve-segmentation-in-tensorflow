...
tf.app.flags.DEFINE_integer('batch_size', 64,
                            """ training batch size """)
tf.app.flags.DEFINE_integer('max_steps', 417390, #227980,
...
def evaluate():
  ...
  filenames = glb('../data/dataset/batch_5_image/*')
  ...
  with tf.Graph().as_default():
    ...
    csvfile = open('score_batch_5_image_417390_20200429_docker.csv', 'w') 
    ...
    for (f,t) in pair_filename:
      ...
      save_prediction_path = '../data/prediction_batch_5_image/'
